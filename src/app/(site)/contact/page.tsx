  ...
  return (
    <main className="flex min-h-svh w-full flex-col scroll-smooth">
      <section className="flex min-h-svh flex-col items-center justify-center px-5 text-center lg:px-40">
        <h1 className="w-fit text-5xl leading-20 text-slate-900 lg:text-7xl">
          Do you have interesting <span className="text-blue-500">Idea</span>?
        </h1>
        <div className="flex flex-row gap-x-7">
          <a href="#2">
            <button className="bg-next-blue my-10 rounded-xl px-5 py-2 text-2xl font-normal text-white transition-all hover:opacity-80">
              Yes✨
            </button>
          </a>
        </div>
      ...
      <section
        ...
        id="2"
      >
        <h2 className="text-5xl leading-20 text-slate-900 lg:text-7xl">
      ...
      <section
        ...
        id="3"
      >
        <h2 className="w-fit text-5xl leading-20 text-slate-900 lg:text-7xl">
