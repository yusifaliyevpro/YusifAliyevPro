...
const config: Config = {
  content: [
    ...
    "./node_modules/@heroui/theme/dist/components/(autocomplete|button|chip|input|navbar|snippet|table|toast|popover|ripple|spinner|form|listbox|divider|scroll-shadow|checkbox|spacer).js",
  ],
  theme: {
    extend: {
      colors: {
